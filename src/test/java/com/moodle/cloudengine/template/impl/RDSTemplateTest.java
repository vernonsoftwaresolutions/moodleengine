 ...
 */
public class RDSTemplateTest {
    private RDSTemplate template;
    @Mock
    ...
    public void setup(){
        ...
        template = new RDSTemplate(factory, reader, cloudFormation);
    ...
    public void buildStack() throws Exception {
        given(reader.getFileAsString("rds_db_template.yaml")).willReturn(templateBody);
